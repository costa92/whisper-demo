...
model = whisper.load_model(name="large-v3",download_root="../models").to(device)
...
for language in languagearr:
    result = model.transcribe(file_path,fp16=isFp16,verbose=False,language=language,initial_prompt=prompt)
    print(result["text"],"\n")
